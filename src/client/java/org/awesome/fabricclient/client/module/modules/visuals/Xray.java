...
@RegisterModule()
@ModuleInfo(name = "Xray", description = "Xray for ores", category = Category.VISUALS, active = true)
public class Xray extends Module {
    ...
    public void onEnable() {
        ...
        // Chunks are 16 x 16
        int playerBlockX = player.getBlockX() / 16;
        int playerBlockZ = player.getBlockZ() / 16;

        LevelChunk levelChunk = chunkSource.getChunk(playerBlockX, playerBlockZ, true);
